...
function help(){
	document.querySelector('.helpFont').style.display = "block";
	document.querySelector('.helpCroix').style.display = "block";
}

function helpEnd(){
	document.querySelector('.helpFont').style.display = "none";
	document.querySelector('.helpCroix').style.display = "none";
}
...
$(document).ready(function() {  // Me permet de charger toute la fonction dans coup, je n'est pas trouvé un équivalent en javascript qui fonctionné simplement.
	...
	// [APPEL F5] Bouton help main menu

	document.querySelector('.help').onclick = help;
	document.querySelector('.helpCroix').onclick = helpEnd;
